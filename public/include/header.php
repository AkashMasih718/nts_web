                ...
                <div class="col-md-8">
                    <div class="widget no-border m-0">
                        <ul class="list-inline pull-right flip sm-pull-none sm-text-center mt-5">
                            ...
                            <li class="m-0 pl-10 pr-10"> <i class="fa fa-envelope-o text-white"></i> <a class="text-white" href="#"><span class="__cf_email__" data-cfemail="51323e3f2530322511283e2423353e3c30383f7f323e3c">[email&#160;protected]</span></a> </li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-2">
...
<div class="main-content">
    ...
    <section id="home" class="divider parallax" data-bg-img="images/bg/bg6.jpg">
        <div class="display-table">
            <div class="display-table-cell">
                <div class="container pt-200 pb-200">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <div class="bg-dark-transparent text-center pt-60 pb-60">
    ...
    <section class="bg-theme-colored">
        <div class="container pt-0 pb-0">
            <div class="call-to-action sm-text-center">
                <div class="row">
                    <div class="col-md-9">
                        <h3 class="mt-5 text-white">Nusrat Trust - We are working on This Project</h3>
                    </div>
                    <div class="col-md-3 text-right flip sm-text-center">
                        <a href="#" class="btn btn-default btn-circled btn-lg mt-5">See Project Live<i class="fa fa-angle-double-right font-16 ml-10"></i></a>
                    </div>
                </div>
            </div>
        </div>
