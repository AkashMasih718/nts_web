...
<body class>
    <div id="wrapper">
        ...
        <div class="main-content">
            ...
            <section id="home" class="divider parallax" data-bg-img="images/bg/bg7.jpg">
                    ...
                    <div class="section-content">
                        <div class="row mt-10">
                            <div class="col-sm-5 col-md-3 mb-sm-20">
                                <h3 class="text-uppercase letter-space-1 mt-0">We Work for <span class="text-theme-colored"> <br>the disabled.</span></h3>
                            ...
                            <div class="col-sm-7 col-md-9">
                                <div class="owl-carousel-3col">
                                    ...
                                    <div class="item">
                                        <div class="box-hover-effect effect1 mb-sm-30">
                                            <div class="thumb"> <a href="#"><img class="img-fullwidth mb-20" src="images/services/bg-5.jpg" alt="..."></a> </div>
                                            <div class="caption">
                                                <h4 class="text-uppercase letter-space-1 mt-0">Solor<span class="text-theme-colored"> Project</span></h4>
                                                <p>Quam distinctio quis perspiciatis facere accusamus perferendis eligendi odit cum nemo fugit eligendi</p>
                                                <p><a href="#" class="btn btn-theme-colored btn-flat mt-10 btn-sm" role="button">Read More</a></p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="item">
                                        <div class="box-hover-effect effect1 mb-sm-30">
                                            <div class="thumb"> <a href="#"><img class="img-fullwidth mb-20" src="images/services/bg6.jpg" alt="..."></a> </div>
                                            <div class="caption">
                                                <h4 class="text-uppercase letter-space-1 mt-0">training To<span class="text-theme-colored"> Shop</span></h4>
                                                <p>Quam distinctio quis perspiciatis facere accusamus perferendis eligendi odit cum nemo fugit eligendi</p>
                                                <p><a href="#" class="btn btn-theme-colored btn-flat mt-10 btn-sm" role="button">Read More</a></p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="item">
                                        <div class="box-hover-effect effect1 mb-sm-30">
                                            <div class="thumb"> <a href="#"><img class="img-fullwidth mb-20" src="images/services/bg-4.jpg" alt="..."></a> </div>
                                            <div class="caption">
                    ...
                    <div class="section-title text-center">
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                                <h2 class="mt-0 line-height-1">Our <span class="text-theme-colored"> Schemes</span></h2>
                                <p>Nusrat Trust For Special Children!</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="owl-carousel-3col" data-nav="true">
                                ...
                                <div class="causes bg-lighter box-hover-effect effect1 maxwidth500 mb-sm-30">
                                    ...
                                    <div class="progress-item mt-0">
                                        <div class="progress mb-0">
                                            <div style="background: #050387;"></div>
                                        </div>
                                    </div>
                                    <div class="causes-details clearfix border-bottom p-15 pt-10">
                                        <h5><a href="#">Food Help Scheme</a></h5>
                                        <p>Those Special Children whose parents cannot meet their nutritional needs due to poverty are given
                                            monthly cash support keeping in view their need.
                                        </p>

                                        <div class="mt-10">
                                            <a class="btn btn-dark btn-theme-colored btn-flat btn-sm pull-left mt-10" href="#">Donate</a>
                                            <div class="pull-right mt-15"><i class="fa fa-heart-o text-theme-colored"></i> Send Your Gift</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="item">
                                <div class="causes bg-lighter box-hover-effect effect1 maxwidth500 mb-sm-30">
                                    ...
                                    <div class="progress-item mt-0">
                                        <div class="progress mb-0">
                                            <div data-percent="84"></div>
                                        </div>
                                    </div>
                                    <div class="causes-details clearfix border-bottom p-15 pt-10">
                                        <h5><a href="#">Wheelchair Scheme</a></h5>
                                        <p>NTSC caters to the mobility needs of growing-up disabled children by providing free wheelchairs
                                            along with a stipend throughout the year.
                                        </p>
                            ...
                            <div class="item">
                                <div class="causes bg-lighter box-hover-effect effect1 maxwidth500 mb-sm-30">
                                    ...
                                    <div class="causes-details clearfix border-bottom p-15 pt-10">
                                        <h5><a href="#">Vocational Training Center</a></h5>
                                        <p>
                                            This Training Center will especially train those special children who are capable
                                            of learning vocational skills in order to make them self- sufficient to earn their livelihood.
                                        </p>
                            ...
                            <div class="item">
                                <div class="causes bg-lighter box-hover-effect effect1 maxwidth500 mb-sm-30">
                                    ...
                                    <div class="causes-details clearfix border-bottom p-15 pt-10">
                                        <h5><a href="#">Rozgar Scheme</a></h5>
                                        <p>
                                            Those special people who want to support their family by hard work, Nusrat Trust makes such speciall
                                            people independent by providing suitable employment.
                                        </p>
                            ...
                            <div class="item">
                                <div class="causes bg-lighter box-hover-effect effect1 maxwidth500 mb-sm-30">
                                    ...
                                    <div class="causes-details clearfix border-bottom p-15 pt-10">
                                        <h5><a href="#">Ramadan sehar and iftar package</a></h5>
                                        <p>
                                            8000 rupees per person is given in cash for Suhr and Iftar to unemployed special persons.
                                        </p>
                            ...
                            <div class="item">
                                <div class="causes bg-lighter box-hover-effect effect1 maxwidth500 mb-sm-30">
                                    ...
                                    <div class="causes-details clearfix border-bottom p-15 pt-10">
                                        <h5><a href="#">Ramadan Ration Package</a></h5>
                                        <p>
                                            Centers are established in various districts of Sindh and Karachi to register those special people who are capable of fasting, and hundreds of such
                                            special people are provided complete ration for the month of Ramadan.
                                        </p>
                ...
                <div class="container pb-0">
                    <div class="section-content">
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <h2 class="mb-30 mb-sm-10 mt-0 mt-sm-10 line-height-1">How <span class="text-theme-colored"> Can Help?</span></h2>
                                <p class="mb-20">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Enim labore iure repellendus quasi nobis, magni nesciunt accusamus vero tempore, at amet velit expedita natus architecto itaque modi cupiditate iusto illo, laborum ipsam vitae minima omnis explicabo doloribus? Atque sunt eos asperiores vitae sed aliquam, libero!</p>
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-6">
                                        <div class="icon-box border-1px p-15 mb-30">
                                            ...
                                            <div class="ml-70 ml-sm-0">
                                                <h5 class="icon-box-title mt-15 mt-sm-0  mb-5 text-uppercase"> Send Your Gift</h5>
                                                <p></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-6">
                                        <div class="icon-box border-1px p-15 mb-30">
                                            ...
                                            <div class="ml-70 ml-sm-0">
                                                <h5 class="icon-box-title mt-15 mt-sm-0 mb-5 text-uppercase">Sponser Child</h5>
                                                <p></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-6">
                                        <div class="icon-box border-1px p-15 mb-30">
                                            ...
                                            <div class="ml-70 ml-sm-0">
                                                <h5 class="icon-box-title mt-15 mt-sm-0 mb-5 text-uppercase">Give Education</h5>
                                                <p></p>
                                            </div>
                                        </div>
                                    </div>
            ...
            <section class="bg-black-222">
                <div class="container-fluid">
                    ...
                    <div class="section-content">
                        <div class="row">
                            <div class="owl-carousel-5col horse-gallery" data-dots="true">
                                ...
                                <div class="gallery-item">
                                    <div class="thumb">
                                        <img class="img-fullwidth" src="images/portfolio/p3.jpg" alt="project">
                                        <div class="overlay-shade"></div>
                                        <div class="icons-holder">
                                            <div class="icons-holder-inner">
                                                <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                                    <a data-lightbox="image" href="images/portfolio/p3.jpg"><i class="fa fa-plus"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="gallery-item">
                                    <div class="thumb">
                                        <img class="img-fullwidth" src="images/portfolio/p4.jpg" alt="project">
                                        <div class="overlay-shade"></div>
                                        <div class="icons-holder">
                                            <div class="icons-holder-inner">
                                                <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                                    <a data-lightbox="image" href="images/portfolio/p4.jpg"><i class="fa fa-plus"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="gallery-item">
                                    <div class="thumb">
                                        <img class="img-fullwidth" src="images/portfolio/p5.jpg" alt="project">
                                        <div class="overlay-shade"></div>
                                        <div class="icons-holder">
                                            <div class="icons-holder-inner">
                                                <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                ...
                                <div class="gallery-item">
                                    <div class="thumb">
                                        <img class="img-fullwidth" src="images/portfolio/p6.jpg" alt="project">
                                        <div class="overlay-shade"></div>
                                        <div class="icons-holder">
                                            <div class="icons-holder-inner">
                                                <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                                    <a data-lightbox="image" href="images/portfolio/p6.jpg"><i class="fa fa-plus"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="gallery-item">
                                    <div class="thumb">
                                        <img class="img-fullwidth" src="images/portfolio/p7.jpg" alt="project">
                                        <div class="overlay-shade"></div>
                                        <div class="icons-holder">
                                            <div class="icons-holder-inner">
                                                <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                                    <a data-lightbox="image" href="images/portfolio/p7.jpg"><i class="fa fa-plus"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="gallery-item">
                                    <div class="thumb">
                                        <img class="img-fullwidth" src="images/portfolio/p8.jpg" alt="project">
                                        <div class="overlay-shade"></div>
                                        <div class="icons-holder">
                                            <div class="icons-holder-inner">
                                                <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                                    <a data-lightbox="image" href="images/portfolio/p8.jpg"><i class="fa fa-plus"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <section id="trainers" data-bg-img="images/pattern/p8.png">
                <div class="container">
                    <div class="section-title text-center">
                        <div class="row">
                            <div class="col-md-12">
                    ...
                    <div class="section-content">
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                ...
                                <iframe width="560" height="315" src="https://www.youtube.com/embed/X208wNEd2u4?si=o6oE3gYvOfoCCqnl" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="gallery-item photography">
                                        <div class="thumb">
                                            ...
                                            <div class="icons-holder">
                                                <div class="icons-holder-inner">
                                                    <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                                        <a class="popup-youtube" href="https://www.youtube.com/watch?v=0O2aH4XLbto"><i class="fa fa-youtube-play"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
